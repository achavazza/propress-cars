...
define( 'CMB2_FIELDAJAXSEARCH_URL', get_template_directory_uri().'/inc/cmb2-plugins/CMB2-field-ajax-search/');
if( ! class_exists( 'CMB2_Field_Ajax_Search' ) ) {
	...
	class CMB2_Field_Ajax_Search {
		...
		public function setup_admin_scripts() {
			...
			wp_enqueue_script( 'jquery-autocomplete-ajax-search', CMB2_FIELDAJAXSEARCH_URL . 'js/jquery.autocomplete.min.js', array( 'jquery' ), self::VERSION, true );
			wp_enqueue_script( 'cmb-ajax-search', CMB2_FIELDAJAXSEARCH_URL . 'js/ajax-search.js', array( 'jquery', 'jquery-autocomplete-ajax-search', 'jquery-ui-sortable' ), self::VERSION, true );
			...
			wp_enqueue_style( 'cmb-ajax-search',  CMB2_FIELDAJAXSEARCH_URL . 'css/ajax-search.css' , array(), self::VERSION );
